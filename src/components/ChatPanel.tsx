...
export function ChatPanel({ activeWidget, headerHeight = 0 }: ChatPanelProps) {
  ...
  return (
    ...
    >
      ...
      {/* Input */}
      <form onSubmit={sendMessage} className={`px-4 py-4 ${showSuggestions && messages.length <= 1 ? '' : 'border-t border-gray-200 dark:border-gray-700'} bg-white dark:bg-gray-800`}>
